    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="max-w-none space-y-8">
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">2. Use License</h2>
            ...
            <p className="text-muted-foreground leading-relaxed">This is the grant of a license, not a transfer of title, and under this license you may not:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">3. Account Terms</h2>
            <ul className="list-disc pl-8 space-y-2 text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">4. Payment Terms</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">5. Cancellation and Termination</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-foreground mb-4">6. Modifications to Service</h2>
            <p className="text-muted-foreground leading-relaxed">
