  ...
  return (
    <section className="bg-card rounded-lg border border-border p-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="heading-tight text-foreground">Zapier / Make</h2>
      </div>
      ...
      <ol className="text-sm text-foreground space-y-2 mb-4 list-decimal pl-5">
        <li>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs font-medium text-foreground">Sample payload</span>
          <button
        ...
        <pre className="text-xs bg-muted border border-border rounded-md p-3 overflow-x-auto font-mono text-foreground">
{samplePayload}
        </pre>
      </div>

      <p className="text-xs text-muted-foreground">
        Each request includes an <code className="px-1 py-0.5 bg-muted rounded">X-Stoneforms-Signature</code>{' '}
