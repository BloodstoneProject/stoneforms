    ...
    <div className="min-h-screen bg-[#fafaf9] text-[#0a0a0a]">
      ...
      <section className="pt-32 pb-20 px-6 sm:px-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl font-light text-[#0a0a0a]/60">Have a question? We'd love to hear from you.</p>
        </div>
      </section>
      ...
      <section className="pb-32 px-6 sm:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <form className="space-y-6 p-10 bg-white/40 backdrop-blur-sm border border-[#0a0a0a]/5 rounded-3xl">
            ...
            <button type="submit" className="w-full py-3 bg-[#0a0a0a] text-[#fafaf9] rounded-full text-sm font-light hover:bg-[#8e1c1c] transition-all duration-300">Send Message</button>
          </form>
        </div>
      </section>
